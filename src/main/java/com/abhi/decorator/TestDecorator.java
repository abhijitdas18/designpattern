...
public class TestDecorator {
	...
	public static void main(String[] args) {
		...
		Beverage milkWith1Sugars = new Sugar(new Milk(new PlainBeverage()));

		System.out.println(milkWith1Sugars.getDescription());
		System.out.println(milkWith1Sugars.getCost());
